    ...
    <div class="container">
      <div class="row align-items-start">
        <div class="col-7">
          ...
          <div class="form-group">
          <label> Content: </label>
            <textarea class="form-control" v-model="note.content" rows="8"> </textarea>
          </div>
          <div class="form-group">
            <div class="buttons">
...
export default {
  ...
  created() {
      ...
      this.note.content = this.$props.content;
      this.note.color = this.$props.color;
      
  },
  methods: {
      async update() {
            this.sendPOSTRequest("/note/"+ this.$props.note_id + "/update", {
